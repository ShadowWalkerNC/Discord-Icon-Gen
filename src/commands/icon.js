/**
 * /icon — Generate a 400×400 profile icon
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const reply = await interaction.reply({
            embeds: [new EmbedBuilder().setColor('#808080').setDescription('\u2726 Generating your icon\u2026')],
        });
        ...
        try {
            ...
            const borderLabel  = border !== 'none' ? ` \u2022 border:${border}` : '';
            ...
            await reply.edit({
                ...
                files: [{ attachment: canvas.toBuffer(), name: 'icon.png' }],
            });
        } catch (err) {
            console.error('[ERROR] Icon generation failed:', err);
            await reply.edit({
